...
/*				
* Procedure version: 20260825.ASH				
* Report Name: Crystal Report			
* Creation Date: 25.08.2026				
* Creator: RoinWorld (Alex Shtyrov)				
* Requested by: 
* Report Description: Procedure for Crystal Report on Inventory Transfer			
* Object type: 
* Category: CR				
*				
* Change log: 	
* 		
* 25/08/2026 - Alex Shtyrov - Initial Version
*/	
...
-- Item
	FROM OPDN O
	INNER JOIN PDN1 P1 ON O."DocEntry" = P1."DocEntry"
